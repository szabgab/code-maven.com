...
1. Find a distribution that does not have this link.
    * The [CPAN Digger](https://cpan-digger.perlmaven.com/recent) has a link of the recently uploaded distributions. There is a column called "VCS". If it has "Add repo" then the repository information is missing.
